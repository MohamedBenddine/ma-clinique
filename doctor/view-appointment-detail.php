...
<head>
    ...
    <title>Ma Clinique|| View Appointment Detail</title>
...
<div style="text-align: center; padding-top: 20px;">
    <?php if ($status == "") { ?>
        <!-- Take Action Button (only show if status is empty) -->
        <button class="btn btn-primary waves-effect waves-light w-lg" 
                data-toggle="modal" data-target="#myModal" 
                style="margin-right: 10px;">
            <i class="bi bi-gear"></i> Take Action
        </button>
    <?php } ?>
    
    <!-- Start Chat Button (show for all appointments) -->
    <a href="chat-dashboard.php?appointment_id=<?php echo $eid; ?>" 
       class="btn btn-success waves-effect waves-light w-lg">
