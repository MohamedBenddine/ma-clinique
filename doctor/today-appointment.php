...
<html lang="en">
<head>
    <title>Ma Clinique | Today's Appointments</title>
            ...
            <div class="col-md-12">
                <div class="widget">
                    <header class="widget-header">
                        <h4 class="widget-title" style="color: blue;">
                            <i class="fa fa-calendar"></i> Today's Appointments - <?php echo date('F d, Y'); ?>
                        </h4>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center">
                                            <div class="alert alert-info">
                                                <i class="fa fa-info-circle"></i> No appointments scheduled for today
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } ?>
